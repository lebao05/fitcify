    ...
    const fetchArtist = async () => {
      try {
        ...
        if (!artistId) {
          ...
          res = await axios.get(
            `http://localhost:5000/api/artist/${artistId}`,
            {
              withCredentials: true,
            }
          );
  ...
  const allSongs =
    artistData?.songs?.map((song) => ({
      ...
      artistId:
        ...
        "",
      imageUrl: artistData.userId?.avatarUrl || "",
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {artistData?.albums?.map((album) => (
            <div
              ...
              onClick={() =>
                setSelectedAlbum(
                  selectedAlbum?._id === album._id ? null : album
                )
              }
            >
              <AlbumCard
                ...
                {artistData.socialLinks.spotify && (
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 168 168"
                    >
                      <path d="M84 0a84 84 0 100 168 84 84 0 000-168zm38.5 120.2a5.25 5.25 0 01-7.2 1.8c-19.7-12-44.5-14.7-73.8-8.1a5.26 5.26 0 11-2.4-10.3c32.6-7.7 60.1-4.5 82.2 9.6a5.26 5.26 0 011.8 7zm10.8-20.8a6.6 6.6 0 01-9.1 2.3c-22.5-13.7-56.8-17.7-83.4-9.7a6.6 6.6 0 11-3.8-12.7c31-9.3 69-4.8 95.8 11.1a6.6 6.6 0 012.3 9zM127 76a7.9 7.9 0 01-10.8 2.8c-25.8-15.8-69.6-17.3-94.5-9.5a7.9 7.9 0 01-4.8-15.2c29.6-9.3 78.3-7.6 108.2 11.3A7.9 7.9 0 01127 76z" />
                    </svg>
                    <span>Spotify</span>
                  </a>
                )}
